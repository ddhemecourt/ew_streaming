function data_out = pdw_constructor_from_table_extended(dat,i)

[TOA_, VC_, Word_type_, Type_, Freq_offset_, Level_offset_, ... 
    Phase_offset_, Arb_seg_TON_, Trise_, Tfall_, Edge_shape_, ...
    Repetitions_, Bandwidth_, Barker_code_,Marker1_,Marker2_,Marker3_] = dat{i,:};
...
if (strcmp(Word_type_,'PDW'))
	...
	CTRL = '1'; % TO DO: extend use case to TCDW in the future
end
...
MOD3 = strcat(dec2bin(0,12),'0011');            %MOD 16 bits in exper mode
